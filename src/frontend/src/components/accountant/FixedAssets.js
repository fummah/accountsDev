...
const FixedAssets = () => {
  ...
  const columns = [
    ...
    { title: 'Purchase Date', dataIndex: 'purchaseDate', key: 'purchaseDate', width: 110, sorter: (a, b) => new Date(a.purchaseDate) - new Date(b.purchaseDate), render: v => v ? moment(v).format('MM/DD/YYYY') : '-' },
