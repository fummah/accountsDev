    ...
    <div style={{ padding: 24 }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 20, flexWrap: 'wrap', gap: 12 }}>
        <div>
          ...
          <Text type="secondary">{dateRange ? `${dateRange[0].format('MM/DD/YYYY')} — ${dateRange[1].format('MM/DD/YYYY')}` : 'All periods (snapshot)'} &middot; {balanceType === 'adjusted' ? 'Adjusted' : 'Unadjusted'}</Text>
        </div>
        <Space wrap>
